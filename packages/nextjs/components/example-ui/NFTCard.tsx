...
export const NFTCard = ({ tokenId }: NFTCardProps) => {
  ...
  // Get marketplace contract info (for approval)
  ...
  const fetchEthPrice = useCallback(async () => {
    if (!priceFeedContract || typeof window === "undefined" || !window.ethereum) return;
    ...
    try {
      ...
      const contract = new ethers.Contract(
        ...
        priceFeedContract.abi as unknown as ethers.ContractInterface,
        provider,
      );
      ...
      const formattedPrice = Number(priceData) / 1e8;
